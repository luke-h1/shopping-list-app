...
import { useUserIdAndNickname } from "@/hooks/useUserNickname";
import { useCreateClientPersister } from "./persister/useCreateClientPersister";
import { useCreateServerSynchronizerAndStart } from "./sync/useCreateServerSync";
...
export default function ShoppingListStore({
  ...
  useCreateClientPersister(storeId, store, valuesCopy, () =>
