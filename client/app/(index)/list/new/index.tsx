...
export default function NewListScreen() {
  ...
  const joinShoppingListCallback = (id: string) => {};
  const [listId, setListId] = useState<string | undefined>(listIdParam);
  const isValidListId = useMemo(() => isValidUUID(listId as string), [listId]);
